...
import pyttsx3    # the bot speaks  something 
import speech_recognition as sr  # recognize the audio and convert it into a text 
import webbrowser  # open a web browser 
import datetime    # return date and time 
import pywhatkit   # Send WhatsApp messages /  Play a YouTube video/ Get information on a particular topic./Perform a Google Search.
import os
...
speaking('I am an embedded system engineering student')
speaking('Fuck you !')
speaking('Je suis Nourreddine Awled Brahim ')
